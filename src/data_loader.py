...
def train_test_split_matrix(matrix, test_ratio=0.2, random_seed=42):
...
def get_or_create_processed_matrices(data_path, processed_dir, test_ratio=0.2):
    """
